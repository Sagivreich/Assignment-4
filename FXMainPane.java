...
public final class FXMainPane extends VBox {
	...
	CourseDBManager  dataMgr = new CourseDBManager();
	...
	private class ButtonHandler implements EventHandler<ActionEvent> {
		...
		public void handle(ActionEvent event) {
			...
			if (event.getTarget()==clear) 
				...
				showDB.setDisable(false);
				getCourse.setDisable(false);
                                alert.setContentText("Course: "+id + "  CRN: "+crn + "  Credits: "+credits 
                ...
                CourseDBElement object = dataMgr.get(Integer.parseInt(crnStr));
							String data;
				if(object!=null)
				{
					data = "Course: " + object.Course_ID + "  CRN: " + object.CRN + "  Credits: " + object.number_of_credits
							+ "  Instructor: " + object.instructor_name + "  Room: " + object.room_number;
				}
				else
				{
					data = "Not Record Found Against given CRN";
				}
